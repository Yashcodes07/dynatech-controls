...
const products = [
    ...
    { id: 2, title: "EOL Poke Yoke Station", category: "PAN INDIA PROJECTS", image: "/pan-5.webp", description: "Prevent errors and ensure product quality before dispatch." },
    { id: 3, title: "Brake Stiffness Tester", category: "PAN INDIA PROJECTS", image: "/pan-1.webp", description: "Measure and validate mechanical stiffness under controlled conditions." },
    { id: 4, title: "YMC BDG UPPER ASSY", category: "PAN INDIA PROJECTS", image: "/pan-4.webp", description: "Dedicated precision assembly machine for repeatable operations." },
    { id: 5, title: "6 Axis Gluing Robot", category: "PAN INDIA PROJECTS", image: "/pan-3.webp", description: "Accurate movement along complex paths for consistent glue beads." },
    { id: 6, title: "BMW Head Lamp ASSY", category: "PAN INDIA PROJECTS", image: "/pan-2.webp", description: "Automated assembly system compliant with BMW standards." },
