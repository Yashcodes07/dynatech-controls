...
const products = [
    { id: 1, title: "Office Building", category: "OTHERS", image: "/building.jpg", description: "Company office and infrastructure." },
    { id: 2, title: "EOL Poke Yoke Station", category: "MACHINE", image: "/img-4.jpg", description: "Prevent errors and ensure product quality before dispatch." },
    { id: 3, title: "Brake Stiffness Tester", category: "VISION", image: "/img-5.jpg", description: "Measure and validate mechanical stiffness under controlled conditions." },
    { id: 4, title: "YMC BDG UPPER ASSY", category: "MACHINE", image: "/img-6.jpg", description: "Dedicated precision assembly machine for repeatable operations." },
    { id: 5, title: "6 Axis Gluing Robot", category: "MACHINE", image: "/img-7.jpg", description: "Accurate movement along complex paths for consistent glue beads." },
    { id: 6, title: "BMW Head Lamp ASSY", category: "MACHINE", image: "/img-8.jpg", description: "Automated assembly system compliant with BMW standards." },
];
